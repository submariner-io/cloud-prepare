...
//
//	mockgen -source=./machinesets.go -destination=./fake/machineset.go -package=fake -copyright_file=../../.header
//
...
func (mr *MockMachineSetDeployerMockRecorder) Delete(machineSet any) *gomock.Call {
...
func (mr *MockMachineSetDeployerMockRecorder) DeleteByName(name, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMachineSetDeployerMockRecorder) Deploy(machineSet any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMachineSetDeployerMockRecorder) GetWorkerNodeImage(machineSet, infraID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
