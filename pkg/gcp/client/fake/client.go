...
//
//	mockgen -source=./client.go -destination=./fake/client.go -package=fake -copyright_file=../../../.header
//
...
func (mr *MockInterfaceMockRecorder) ConfigurePublicIPOnInstance(instance any) *gomock.Call {
...
func (mr *MockInterfaceMockRecorder) DeleteFirewallRule(projectID, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) DeletePublicIPOnInstance(instance any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) GetFirewallRule(projectID, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) GetInstance(zone, instance any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) InsertFirewallRule(projectID, rule any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) InstanceHasPublicIP(instance any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) ListInstances(zone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) UpdateFirewallRule(projectID, name, rule any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) UpdateInstanceNetworkTags(project, zone, instance, tags any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
